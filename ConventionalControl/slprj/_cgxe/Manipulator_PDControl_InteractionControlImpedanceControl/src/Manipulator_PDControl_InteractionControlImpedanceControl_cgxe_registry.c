...
#define S_FUNCTION_NAME                Manipulator_PDControl_InteractionControlImpedanceControl_cgxe
#include "simstruc.h"
#include "Manipulator_PDControl_InteractionControlImpedanceControl_cgxe.h"
#define MDL_START
...
static void mdlStart(SimStruct* S)
{
  ...
  success =
    cgxe_Manipulator_PDControl_InteractionControlImpedanceControl_method_dispatcher
  ...
  mxArray* prhs[])
{
...

  {
    ...
    checksumData[0] = 1738012218;
    checksumData[1] = 1025990958;
    checksumData[2] = 2666843570;
    checksumData[3] = 427605183;
