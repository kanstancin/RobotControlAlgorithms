...
#define S_FUNCTION_NAME                Manipulator_PDControl_InteractionControlHMForCon_demo_cgxe
#include "simstruc.h"
#include "Manipulator_PDControl_InteractionControlHMForCon_demo_cgxe.h"
#define MDL_START
...
static void mdlStart(SimStruct* S)
{
  ...
  success =
    cgxe_Manipulator_PDControl_InteractionControlHMForCon_demo_method_dispatcher
  ...
  mxArray* prhs[])
{
...

  {
    ...
    checksumData[0] = 1166477832;
    checksumData[1] = 1574455246;
    checksumData[2] = 4280719725;
    checksumData[3] = 475856968;
