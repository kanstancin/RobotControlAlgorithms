...
#define S_FUNCTION_NAME                Manipulator_PDControl_RobustInverseDynamics_cgxe
#include "simstruc.h"
#include "Manipulator_PDControl_RobustInverseDynamics_cgxe.h"
#define MDL_START

static void mdlStart(SimStruct* S)
{
  unsigned int success;
  success = cgxe_Manipulator_PDControl_RobustInverseDynamics_method_dispatcher(S,
  ...
  mxArray* prhs[])
{
...

  {
    ...
    checksumData[0] = 1288389012;
    checksumData[1] = 4215818692;
    checksumData[2] = 3351302380;
    checksumData[3] = 2041831892;
