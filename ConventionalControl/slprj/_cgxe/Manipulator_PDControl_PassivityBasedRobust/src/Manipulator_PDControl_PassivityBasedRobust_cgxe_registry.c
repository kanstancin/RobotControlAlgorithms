...
#define S_FUNCTION_NAME                Manipulator_PDControl_PassivityBasedRobust_cgxe
#include "simstruc.h"
...
static void mdlStart(SimStruct* S)
{
  ...
  success = cgxe_Manipulator_PDControl_PassivityBasedRobust_method_dispatcher(S,
  ...
  mxArray* prhs[])
{
...

  {
    ...
    checksumData[0] = 1544953500;
    checksumData[1] = 1585057098;
    checksumData[2] = 3041776481;
    checksumData[3] = 2090276594;
