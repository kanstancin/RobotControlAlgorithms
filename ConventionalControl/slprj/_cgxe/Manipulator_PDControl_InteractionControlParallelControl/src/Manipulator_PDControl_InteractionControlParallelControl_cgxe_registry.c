...
#define S_FUNCTION_NAME                Manipulator_PDControl_InteractionControlParallelControl_cgxe
#include "simstruc.h"
...
static void mdlStart(SimStruct* S)
{
  ...
  success =
    cgxe_Manipulator_PDControl_InteractionControlParallelControl_method_dispatcher
  ...
  mxArray* prhs[])
{
...

  {
    ...
    checksumData[0] = 2650887320;
    checksumData[1] = 3956998718;
    checksumData[2] = 467272295;
    checksumData[3] = 3576682034;
