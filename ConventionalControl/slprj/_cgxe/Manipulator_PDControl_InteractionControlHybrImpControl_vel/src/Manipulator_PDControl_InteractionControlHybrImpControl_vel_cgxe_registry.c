...
#define S_FUNCTION_NAME                Manipulator_PDControl_InteractionControlHybrImpControl_vel_cgxe
#include "simstruc.h"
#include "Manipulator_PDControl_InteractionControlHybrImpControl_vel_cgxe.h"
#define MDL_START
...
static void mdlStart(SimStruct* S)
{
  ...
  success =
    cgxe_Manipulator_PDControl_InteractionControlHybrImpControl_vel_method_dispatcher
  ...
  mxArray* prhs[])
{
...

  {
    ...
    checksumData[0] = 2404329535;
    checksumData[1] = 70928477;
    checksumData[2] = 328834033;
    checksumData[3] = 1720163615;
