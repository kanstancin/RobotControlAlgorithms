...
#define S_FUNCTION_NAME                Manipulator_PDControl_InverseDynamics_cgxe
#include "simstruc.h"
#include "Manipulator_PDControl_InverseDynamics_cgxe.h"
#define MDL_START

static void mdlStart(SimStruct* S)
{
  unsigned int success;
  success = cgxe_Manipulator_PDControl_InverseDynamics_method_dispatcher(S,
  ...
  mxArray* prhs[])
{
...

  {
    ...
    checksumData[0] = 626979533;
    checksumData[1] = 3601710179;
    checksumData[2] = 3792061292;
    checksumData[3] = 1208821019;
