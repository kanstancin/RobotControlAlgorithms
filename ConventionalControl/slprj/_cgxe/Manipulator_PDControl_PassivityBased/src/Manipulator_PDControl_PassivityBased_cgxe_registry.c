...
#define S_FUNCTION_NAME                Manipulator_PDControl_PassivityBased_cgxe
#include "simstruc.h"
#include "Manipulator_PDControl_PassivityBased_cgxe.h"
#define MDL_START

static void mdlStart(SimStruct* S)
{
  unsigned int success;
  success = cgxe_Manipulator_PDControl_PassivityBased_method_dispatcher(S,
  ...
  mxArray* prhs[])
{
...

  {
    ...
    checksumData[0] = 1228503729;
    checksumData[1] = 4151171884;
    checksumData[2] = 1082442976;
    checksumData[3] = 3567845862;
